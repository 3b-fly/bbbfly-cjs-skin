...
bbbfly.morph.FileUploader=function(a,b,c){a=a||{};ng_MergeDef(a,{Controls:{ButtonsPanel:{L:8,R:7,H:38,T:0,ScrollBars:ssDefault,Controls:{AddFiles:{Type:"bbbfly.morph.ContentButton",L:-3,W:"50%",T:5,H:28,Data:{TextAlign:bbbfly.Btn.textalign.center}},RemoveFiles:{Type:"bbbfly.morph.ContentButton",R:-2,W:"50%",T:5,H:28,Data:{TextAlign:bbbfly.Btn.textalign.center}}}},ContentPanel:{L:5,R:5,T:43,B:5,Controls:{FilesList:{Type:"bbbfly.morph.ContentList",L:0,R:0,T:0,B:0}}},ProgressPanel:{Type:"bbbfly.morph.ContentPanel",
