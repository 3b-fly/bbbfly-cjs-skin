...
var bbbfly=bbbfly||{};bbbfly.morph=bbbfly.morph||{};bbbfly.morph.list={};bbbfly.morph.checklist={};bbbfly.morph.list._onGetRowClassName=function(a,b){var c="",d=a.BaseClassName;String.isString(d)||(d="");if(b.H||a.ItemHeight)c+="FixedHRow "+d;b.Static&&(c+="StaticRow "+d);return c+"Row"};bbbfly.morph.list._onGetTreeImg=function(){var a=Function.isFunction(this.OnGetTreeImg.callParent)?this.OnGetTreeImg.callParent():this.TreeImg;return bbbfly.morph.misc.GetImgShade(a,this.Shade)};
