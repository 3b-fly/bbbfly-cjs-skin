...
bbbfly.morph.ContentList=function(a,b,c){a=a||{};bbbfly.morph.ngmisc.ApplyFrameShade(a);ng_MergeDef(a,{Events:{OnGetRowClassName:bbbfly.morph.list._onGetRowClassName},OverrideEvents:{OnGetTreeImg:bbbfly.morph.list._onGetTreeImg,OnGetCheckImg:bbbfly.morph.list._onGetCheckImg}});bbbfly.morph.ngmisc.ApplyClassShade(a,"ContentList");return ngCreateControlAsType(a,"bbbfly.List",b,c)};
