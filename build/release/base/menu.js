...
bbbfly.morph.menu._onGetCheckImg=function(a,b){if(!this.ShowCheckboxes||!b.Checked)return null;a=Function.isFunction(this.OnGetCheckImg.callParent)?this.OnGetCheckImg.callParent():this.CheckImg;return bbbfly.morph.misc.GetImgShade(a,this.Shade)};bbbfly.morph.menu._onGetSubMenuImg=function(){var a=Function.isFunction(this.OnGetSubMenuImg.callParent)?this.OnGetSubMenuImg.callParent():this.SubMenuImg;return bbbfly.morph.misc.GetImgShade(a,this.Shade)};
