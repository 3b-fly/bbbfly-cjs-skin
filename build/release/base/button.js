...
var bbbfly=bbbfly||{};bbbfly.morph=bbbfly.morph||{};bbbfly.morph.ButtonPanel=function(a,b,c){bbbfly.morph.misc.ApplyFrameShade(a);bbbfly.morph.misc.ApplyClassShade(a,"ButtonPanel");return ngCreateControlAsType(a,"bbbfly.Btn",b,c)};bbbfly.morph.ContentButton=function(a,b,c){bbbfly.morph.misc.ApplyFrameShade(a);bbbfly.morph.misc.ApplyClassShade(a,"ContentButton");return ngCreateControlAsType(a,"bbbfly.Btn",b,c)};
bbbfly.morph.LargeContentButton=function(a,b,c){bbbfly.morph.misc.ApplyFrameShade(a);bbbfly.morph.misc.ApplyClassShade(a,"LargeContentButton");return ngCreateControlAsType(a,"bbbfly.Btn",b,c)};bbbfly.morph.ContentFlatButton=function(a,b,c){bbbfly.morph.misc.ApplyFrameShade(a);bbbfly.morph.misc.ApplyClassShade(a,"ContentFlatButton");return ngCreateControlAsType(a,"bbbfly.Btn",b,c)};
