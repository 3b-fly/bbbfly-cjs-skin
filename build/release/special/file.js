...
Controls:{ProgressBar:{Type:"bbbfly.morph.ProgressBar",L:20,R:20,T:"50%",style:{marginTop:"-15px"}},ProgressMessage:{Type:"bbbfly.morph.Label",L:5,R:5,T:"50%",style:{marginTop:"10px"},Data:{TextAlign:bbbfly.Text.textalign.center,AutoSize:bbbfly.Text.autosize.vertical}}}}}});bbbfly.morph.misc.ApplyControlClassName(a,"FileUploader");return ngCreateControlAsType(a,"bbbfly.FileUploader",b,c)};ngUserControls=ngUserControls||[];
