...
var bbbfly=bbbfly||{};bbbfly.morph=bbbfly.morph||{};bbbfly.morph.map=bbbfly.morph.map||{};bbbfly.morph.map.sidebar={};
...
"MapBox");return ngCreateControlAsType(a,"bbbfly.MapCrate",b,c)};
...
b,c)};
bbbfly.morph.MapZoomSlider=function(a,b,c){a=a||{};var d=bbbfly.Morph.GetDefTheme(a);ng_MergeDef(a,{Controls:{ZoomIn:{Type:"bbbfly.morph.PanelIconButton",style:{zIndex:2},Data:{Icon:"plus"}},ZoomOut:{Type:"bbbfly.morph.PanelIconButton",style:{zIndex:2},Data:{Icon:"minus"}},Slider:{Type:"bbbfly.morph.ContentFrame",style:{zIndex:1},Controls:{Rail:{Type:"bbbfly.Frame",Data:{Theme:d?d.ID:null}},Handle:{Type:"bbbfly.morph.InverseButton"}}}}});bbbfly.morph.misc.ApplyClassName(a.Controls.Slider.Controls.Rail,"SliderRail");
